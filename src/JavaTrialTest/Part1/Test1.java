...
// 1. What will be the result of trying to compile and run an application in
// which the following is the only declaration of a main method? (Assume the
...
// B. The class will compile and run, writing "hello world" to the standard
// output.
