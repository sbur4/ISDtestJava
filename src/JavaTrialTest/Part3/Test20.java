...
// 20. When you try to compile the following source code, it produces a compiler
// warning to the effect that the variable tmp may not have been initialized:
...
// D. Remove line 4 and insert a new line after 2 so tmp becomes a member variable instead of a local variable in showType: String tmp ;
