public class JavaDevTest5 {
    ...
    // 5. Can you please give examples of design patterns implemented in a standard
    // Java API? +

    // java.lang.Runtime: In every Java application there is only one Runtime
    ...
    // Swing API.
    // The getInstance() method in java.util.Calendar is an example of a simple form
    // of the Factory Method design pattern.
    ...
    // in class Object and the use of java.lang.Cloneable interface to grant
