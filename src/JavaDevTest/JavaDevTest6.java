...
// 6. Let’s assume you have two classes representing some services: Service1Impl
// and Service2Impl. Client (represented as Client1Impl class) expects to access
// functionality of these two services through one class: Client1Service.

/**
 * A. How will you reuse functionality of Service1Impl and Service1Imp2 in
 * Client1Service? B. Does Java support multiple inheritance?
 */
/**
